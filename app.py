    ...
    try:
        ...
        if user_message:
            ...
            if matches:
                ...
                # --- ΠΡΟΣΘΕΣΕ ΑΥΤΑ ΠΟΥ ΒΡΗΚΕΣ στα already_suggested ΑΚΟΜΑ κι αν είναι <3 ---
                if dishes_branch1:
                    branch1_ids = [d["id"] for d in dishes_branch1]
                    already_suggested = already_suggested + [i for i in branch1_ids if i not in already_suggested]
                    session["suggested_dish_ids"] = already_suggested
